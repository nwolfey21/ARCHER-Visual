function objMatrix = importOBJ(filename)
%% Import data from text file.
% Script for importing data from the following text file:
%
%    /home/noah/Documents/ARCHER/DataVisualization/Skin.obj
%
% To extend the code to different selected data or a different text file,
% generate a function instead of a script.

% Auto-generated by MATLAB on 2014/04/10 17:17:39
...
R = cellfun(@(x) ischar(x) && strcmp(x,'v'),raw); % Find non-numeric cells
raw(R) = {1.0}; % Replace non-numeric cells

%% Replace specified string with 2.0
R = cellfun(@(x) ischar(x) && strcmp(x,'vn'),raw); % Find non-numeric cells
